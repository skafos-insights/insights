defmodule Insights.MembersTest do
  use Insights.DataCase

  alias Insights.Members

  describe "members" do
    alias Insights.Members.Member
    ...
    test "create_member/1 with valid data creates a member" do
      ...
      assert member.description == "some description"
    ...
    test "update_member/2 with valid data updates the member" do
      ...
      assert member.description == "some updated description"
